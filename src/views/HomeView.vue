<template>
  <div class="home">
    <form id="form-buscar" >
      ...
      <button id = "btnBuscar" @click="buscarCancion"><img id="lupa" src="@/assets/lupa.png" alt=""></button>
    </form>
  <img v-if="canciones.length === 0" src="https://cdn-icons-png.flaticon.com/512/5088/5088080.png" alt="">
    <h4 v-if="canciones.length === 0" style="width:100%; text-align:center; font-size:4em; color:#16249e">VUECLOUD</h4>
...
#input-buscar{
  background: none;
  border: 2px solid rgb(120, 151, 252);
  height: 30px;
  width: 300px;
  border-radius: 10px;
}
